...
import { FiX, FiGithub, FiLock } from 'react-icons/fi'; // Install react-icons jika belum: npm install react-icons
    ...
    >
      ...
      >
        ...
        <div className="p-6 flex flex-col gap-4">
            ...
            <div
              className="mt-4 inline-flex items-center justify-center gap-2 font-semibold bg-zinc-700 p-3 px-5 rounded-full w-full border border-zinc-600 text-zinc-300 cursor-not-allowed select-none"
        >
              <FiLock />
